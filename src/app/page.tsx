...
export default function Home() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Hero Section */}
      <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] bg-gradient-to-b from-slate-900 to-slate-800 overflow-hidden">
        {/* Gradient Orbs */}
        ...
        <div className="container relative px-4 space-y-8 text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-white max-w-4xl mx-auto">
          ...
          <div className="pt-8 grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto text-slate-300 text-sm">
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4 text-center">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-slate-900">Todo lo que necesitas para tu facturación</h2>
      ...
      <section className="relative py-20 bg-slate-900">
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Empieza a facturar de forma profesional</h2>
            <p className="text-lg text-slate-300 mb-8">Únete a miles de profesionales que ya confían en nosotros</p>
            <p className="text-lg text-red-400 mb-4">¡Oferta limitada! Comienza hoy y obtén un 20% de descuento.</p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href="/auth/register">
                <Button size="lg" className="w-full sm:w-auto bg-white text-slate-900 hover:bg-slate-100 transition-transform transform hover:scale-105">
                  Comenzar Ahora
                  <ArrowRight className="ml-2 h-4 w-4" />
                </Button>
              </Link>
